...
#8 fluxos
    ...
    return ((avg_bw / HOST_LINK_BW) * 100) /8
...
if __name__ == "__main__":
    ...
    print "           --------------------------"
    print "MPTCP 1 Flow | " + str(values[("ecmp", 1)])[:4] + "% \t " + str(values[("kshort", 1)])[:4] + "%"
    print "MPTCP 8 Flow | " + str(values[("ecmp", 8)])[:4] + "% \t " + str(values[("kshort", 8)])[:4] + "%"
